...
Lists are an even more flexible way of combining multiple objects into a single object. Using lists, we can combine together vectors of different lengths:
...
```{r}
school_info <- list(school_name = "iCourts", students = students, 
